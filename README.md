...
|14|[Исследование надежности заемщиков](https://github.com/Eudgene8/data_preprocessing)||pandas, matplotlib.pyplot, seaborn, предобработка данных|

Проведено исследование влияния семейного положения и
